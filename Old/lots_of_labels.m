...
%fig2 = load('3D_DOS_2_Jx_100_h_0.fig','-mat');
fig3 = load('3D_Raman_2_Jx_30_h_0_2.fig','-mat');
fig4 = load('3D_Raman_2_Jx_100_h_0_2.fig','-mat');
fig5 = load('3D_Raman_2_Jx_143_h_0_2.fig','-mat');
...
%     % legend({'\rho_{--}', '\rho_{++}', '\rho_{+-}','\rho_{total}'}, 'Location', 'NorthEast');
%      hold off;
%      filename = ['3D_DOS_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(100*h),'7'];
%      saveas(hh,filename)
%      print(hh, '-dpng', filename);
%      print(hh, '-depsc', filename);
...
hold off;
filename = ['3D_Raman_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_27'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
