function out = KitaevRaman_a2_5_22(N,bins,flag,nn,jx,jz,h)
...
ylabel('k_y');
hold off;
filename = ['Fermi_surface_1_Jx_',num2str(round(100*jx)),'_h_',num2str(h*100)];
saveas(hh,filename)
