...
for n = 1:nn
    ...
    out = KitaevRaman_a1_4_p(N,bins,flag,nn,Jx,Jz,h);
...
%set(gca,'YTick',2*(0:5));
hold off;
filename = ['3D_DOS_Slab_Jx_4_p',num2str(round(100*Jx)),'_h_',num2str(100*h),'_2'];
saveas(hh,filename)
...
hold off;
filename = ['3D_Raman_Slab_Jx_4_p_',num2str(round(100*Jx)),'_h_',num2str(h*100)];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
hold off;
filename = ['3D_Raman_Slab_Jx_4_p_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_3'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
hold off;
filename = ['3D_Raman_Slab_Jx_4_p_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_2'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'I_{aa}', 'I_{aa,ac}', 'I_{aa,cc}','I_{ac}','I_{ac,cc}','I_{cc}'}, 'Location', 'NorthEast');
hold off;
filename = ['3D_Raman_edge1_Jx_4_p_',num2str(round(100*Jx)),'_h_',num2str(h*100)];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'I_{aa}','-I_{aa,cc}/3','I_{cc}/9'}, 'Location', 'NorthEast');
hold off;
filename = ['3D_Raman_edge1_Jx_4_p_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_3'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'I_{aa}','I_{ac}'}, 'Location', 'NorthEast');
hold off;
filename = ['3D_Raman_edge1_Jx_4_p_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_2'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
