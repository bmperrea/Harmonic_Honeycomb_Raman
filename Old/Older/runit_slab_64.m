...
for n = 1:nn
    ...
    out = KitaevRaman_a2_5_64(N,bins,flag,nn,Jx,Jz,h);
...
%set(gca,'YTick',2*(0:5));
hold off;
filename = ['3D_DOS_Slab_64_Jx_',num2str(round(100*Jx)),'_h_',num2str(100*h),'_2'];
saveas(hh,filename)
...
hold off;
filename = ['3D_Raman_Slab_64_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100)];
saveas(hh,filename)
print(hh, '-dpng', filename);
...
hold off;
filename = ['3D_Raman_Slab_64_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_3'];
saveas(hh,filename)
print(hh, '-dpng', filename);
...
hold off;
filename = ['3D_Raman_Slab_64_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_2'];
saveas(hh,filename)
print(hh, '-dpng', filename);
