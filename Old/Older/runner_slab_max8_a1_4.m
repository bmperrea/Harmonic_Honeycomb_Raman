...
hold on;
plot(Ih_4{1},Ih_4{2},Ih_8{1},Ih_8{2},Ih_16{1},Ih_16{2},Ih_32{1},Ih_32{2},Ih_64{1},Ih_64{2} );
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih_4{1}(Ev)),log(Ih_4{2}(Ev)),...
    log(Ih_8{1}(Ev)),log(Ih_8{2}(Ev)),log(Ih_16{1}(Ev)),log(Ih_16{2}(Ev)),...
    log(Ih_32{1}(Ev)),log(Ih_32{2}(Ev)),log(Ih_64{1}(Ev)),log(Ih_64{2}(Ev)) );
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(Ih2_4{1},Ih2_4{2},Ih2_8{1},Ih2_8{2},Ih2_16{1},Ih2_16{2},Ih2_32{1},Ih2_32{2},Ih2_64{1},Ih2_64{2} );
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih2_4{1}(Ev)),log(Ih2_4{2}(Ev)),...
    log(Ih2_8{1}(Ev)),log(Ih2_8{2}(Ev)),log(Ih2_16{1}(Ev)),log(Ih2_16{2}(Ev)),...
    log(Ih2_32{1}(Ev)),log(Ih2_32{2}(Ev)),log(Ih2_64{1}(Ev)),log(Ih2_64{2}(Ev)) );
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(I0_4{1},I0_4{2},I0_8{1},I0_8{2},I0_16{1},I0_16{2},I0_32{1},I0_32{2},I0_64{1},I0_64{2} );
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(log(I0_4{1}(Ev)),log(I0_4{2}(Ev)),...
    log(I0_8{1}(Ev)),log(I0_8{2}(Ev)),log(I0_16{1}(Ev)),log(I0_16{2}(Ev)),...
    log(I0_32{1}(Ev)),log(I0_32{2}(Ev)),log(I0_64{1}(Ev)),log(I0_64{2}(Ev)) );
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
I0_64p = I0_0; %runit_hslab_8(64,1,round(N/sqrt(2)),J,0);
Ih_64p = I0_0; %runit_hslab_8(64,1,round(N/sqrt(2)),J,0.1);
Ih2_64p = I0_0; %runit_hslab_8(64,1,round(N/sqrt(2)),J,0.03);
...
hh=figure;%('Position',position);
hold on;
plot(I0_64p{1},I0_64p{2},I0_64{1},I0_64{2});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(log(I0_64p{1}(Ev)),log(I0_64p{2}(Ev)),log(I0_64{1}(Ev)),log(I0_64{2}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(Ih_64p{1},Ih_64p{2},Ih_64{1},Ih_64{2});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH sinons'])
xlabel('\omega/J^z');
ylabel('DOS');
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih_64p{1}(Ev)),log(Ih_64p{2}(Ev)),log(Ih_64{1}(Ev)),log(Ih_64{2}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH sinons lod'])
xlabel('log(\omega/J^z)');
ylabel('log(DOS)');
...
hh=figure;%('Position',position);
hold on;
plot(Ih2_64p{1},Ih2_64p{2},Ih2_64{1},Ih2_64{2});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH sinons'])
xlabel('\omega/J^z');
ylabel('DOS');
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih2_64p{1}(Ev)),log(Ih2_64p{2}(Ev)),log(Ih2_64{1}(Ev)),log(Ih2_64{2}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH sinons lod'])
xlabel('log(\omega/J^z)');
ylabel('log(DOS)');
