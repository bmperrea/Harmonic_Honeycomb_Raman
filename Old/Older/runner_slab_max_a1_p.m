...
Ih_64p  = runit_slab_a1_64_p(1,.1);
Ih_32p  = runit_slab_a1_32_p(1,.1);
Ih_16p  = runit_slab_a1_16_p(1,.1);
Ih_8p   = runit_slab_a1_8_p(1,.1);
Ih_4p   = runit_slab_a1_4_p(1,.1);
Ih_2p   = runit_slab_a1_2_p(1,.1);
...
hold off;
filename = ['3D_Raman_slab1_p_10_magneticfieldcomparison'];
savefig(filename)
...
legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'SouthEast');
hold off;
filename = ['3D_Raman_slab1_p_10_logmagneticfieldcomparison'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'SouthEast');
hold off;
filename = ['3D_Raman_slab1_p_10_logmagneticfieldcomparison_edge'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
Ih2_64p  = runit_slab_a1_64_p(1,.03);
Ih2_32p  = runit_slab_a1_32_p(1,.03);
Ih2_16p  = runit_slab_a1_16_p(1,.03);
Ih2_8p   = runit_slab_a1_8_p(1,.03);
Ih2_4p   = runit_slab_a1_4_p(1,.03);
Ih2_2p   = runit_slab_a1_2_p(1,.03);
...
legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'SouthEast');
hold off;
filename = ['3D_Raman_slab1_p_03_magneticfieldcomparison'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'SouthEast');
hold off;
filename = ['3D_Raman_slab1_p_03_logmagneticfieldcomparison'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'SouthEast');
hold off;
filename = ['3D_Raman_slab1_p_03_logmagneticfieldcomparison_edge'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
I0_64p  = runit_slab_a1_64_p(1,0);
I0_32p  = runit_slab_a1_32_p(1,0);
I0_16p  = runit_slab_a1_16_p(1,0);
I0_8p   = runit_slab_a1_8_p(1,0);
I0_4p   = runit_slab_a1_4_p(1,0);
I0_2p   = runit_slab_a1_2_p(1,0);
%Ih_1   = runit_slab_16(1,.1);
...
legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'SouthEast');
hold off;
filename = ['3D_Raman_slab1_p_0_magneticfieldcomparison'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'SouthEast');
hold off;
filename = ['3D_Raman_slab1_p_0_logmagneticfieldcomparison'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'SouthEast');
hold off;
filename = ['3D_Raman_slab1_p_0_logmagneticfieldcomparison_edge'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);


diary 3D_slab_diary_a1p
