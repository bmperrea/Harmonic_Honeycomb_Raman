function out = KitaevRaman_a2_5_4(N,bins,flag,nn,jx,jz,h)
...
%             B-conj(A)-2i*conj(d),1i*(a+b),-B-conj(A),1i*(-a+b+2i*jz)];
  ...
  R{n} = [R1{n}, R2{n}, zero, zero;...
       R2{n}', R1{n}, R2{n}, zero; ...
       zero, R2{n}', R1{n}, R2{n}; ...
       zero, zero, R2{n}', R1{n}]/2;
   
   Re{n} = [R1{n}, zero, zero, zero; ...
          zero, zero, zero, zero; ...
          zero, zero, zero, zero; ...
         zero, zero, zero, R1{n}]/2;
...
ylabel('k_y');
hold off;
filename = ['Fermi_surface_4_Jx_',num2str(round(100*jx)),'_h_',num2str(h*100)];
saveas(hh,filename)
