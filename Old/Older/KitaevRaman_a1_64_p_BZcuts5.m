function out = KitaevRaman_a1_64_p_BZcuts(N,bins,flag,nn,jx,jz,h,mmmm,nnnn)
...
for xind = pts
    ...
    for yind = pts
        x = ( (xind + r1)/25 -1-1/25+2*mmmm/25)*pi*sqrt(1/3)/N;
        y = ( (yind + r2)/25 -1-1/25+2*nnnn/25)*pi*sqrt(3/29)/N; 
