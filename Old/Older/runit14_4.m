...
% %set(gca,'YTick',2*(0:5));
% %hold off;
% filename = ['3D_DOS_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(100*h),'_2'];
% saveas(hh,filename)
...
% hold off;
% filename = ['3D_Raman_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_2'];
% saveas(hh,filename)
% print(hh, '-dpng', filename);
% 
% %Print the ratios
