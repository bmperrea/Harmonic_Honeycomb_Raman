...
figh = load('3D_DOS_Slab_32_Jx_100_h_10_2.fig','-mat');
figh2 = load('3D_DOS_Slab_32_Jx_100_h_3_2.fi','-mat');
fig0 = load('3D_DOS_Slab_32_Jx_100_h_0_2.fi','-mat');
...
hold off;
filename = ['3D_DOS_slab1_10_magneticfieldcomparison2'];
savefig(filename)
...
hold off;
filename = ['3D_DOS_slab1_10_logmagneticfieldcomparison2'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
% hold off;
% filename = ['3D_DOS_slab1_10_logmagneticfieldcomparison_edge2'];
% savefig(filename)
% print(hh, '-dpng', filename);
% print(hh, '-depsc', filename);
...
legend({'L=\infty','L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'NorthEast');
hold off;
filename = ['3D_DOS_slab1_03_magneticfieldcomparison2'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
legend({'L=\infty','L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'NorthWest');
hold off;
filename = ['3D_DOS_slab1_03_logmagneticfieldcomparison2'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
% legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'NorthEast');
% hold off;
% filename = ['3D_DOS_slab1_03_logmagneticfieldcomparison_edge'];
% savefig(filename)
% print(hh, '-dpng', filename);
% print(hh, '-depsc', filename);
...
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH spinons: kappa = 0 J in a1 slab'])
xlabel('\omega/J');
ylabel('I_{ac}');
legend({'L=\infty','L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'NorthEast');
hold off;
filename = ['3D_DOS_slab1_0_magneticfieldcomparison2'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH spinons: kappa = 0 J in a1 slab (log plot)'])
xlabel('log(\omega/J)');
ylabel('log(I_{ac})');
legend({'L=\infty','L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'NorthWest');
hold off;
filename = ['3D_DOS_slab1_0_logmagneticfieldcomparison2'];
savefig(filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
% legend({'L=64','L=32','L=16','L=8','L=4','L=2'}, 'Location', 'NorthEast');
% hold off;
% filename = ['3D_DOS_slab1_0_logmagneticfieldcomparison_edge'];
% savefig(filename)
% print(hh, '-dpng', filename);
% print(hh, '-depsc', filename);
