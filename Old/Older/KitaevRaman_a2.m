...
for xind = pts
    ...
    H2 = [-1i*b2, B2, 1i*b2, 2i*d2+B2; ...
            B2, 1i*b2, -B2-2i*d2, 1i*b2; ...
            1i*b2, d2-B2, -1i*b2, -B2; ...
            B2-2i*d2, 1i*b2, -B, 1i*b2];
    ...
    for n =1:3
        ...
        R1{n} = [1i*(ac{n}-bc{n}-2i*jzc{n}), Ac{n}+conj(Bc{n}), 1i*(ac{n}+bc{n}), -Ac{n}+2i*dc{n}+conj(Bc{n});...
                Bc{n}+conj(Ac{n}), -1i*(ac{n}-bc{n}+2i*jzc{n}), -Bc{n}+conj(Ac{n})-2i*conj(dc{n}), 1i*(ac{n}+bc{n});...
        ...
        R2{n} = [-1i*b2c{n}, B2c{n}, 1i*b2c{n}, 2i*d2c{n}+B2c{n}; ...
                B2c{n}, 1i*b2c{n}, -B2c{n}-2i*d2c{n}, 1i*b2c{n}; ...
                1i*b2c{n}, d2c{n}-B2c{n}, -1i*b2c{n}, -B2c{n}; ...
                B2c{n}-2i*d2c{n}, 1i*b2c{n}, -Bc{n}, 1i*b2c{n}];
