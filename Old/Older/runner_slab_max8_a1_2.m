...
hold on;
plot(Ih_64{1},Ih_64{2},...
    Ih_32{1},Ih_32{2},Ih_16{1},Ih_16{2},...
Ih_8{1},Ih_8{2},Ih_4{1},Ih_4{2},Ih_2{1},Ih_2{2},...
Ih_1{1},Ih_1{2});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH spinons: kappa = 0.1 J in a1 slab'])
xlabel('\omega/J^z');
ylabel('DOS');
legend({'L=64','L=32','L=16','L=8','L=4','L=2','L=1'}, 'Location', 'SouthEast');
hold off;
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih_64{1}(Ev)),log(Ih_64{2}(Ev)),...
    log(Ih_32{1}(Ev)),log(Ih_32{2}(Ev)),log(Ih_16{1}(Ev)),log(Ih_16{2}(Ev)),...
    log(Ih_8{1}(Ev)),log(Ih_8{2}(Ev)),log(Ih_4{1}(Ev)),log(Ih_4{2}(Ev)),log(Ih_2{1}(Ev)),log(Ih_2{2}(Ev)),...
log(Ih_1{1}(Ev)),log(Ih_1{2}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(Ih_64{1},Ih_64{11},...
    Ih_32{1},Ih_32{11},Ih_16{1},Ih_16{11},...
Ih_8{1},Ih_8{11},Ih_4{1},Ih_4{11},Ih_2{1},Ih_2{11},...
Ih_1{1},Ih_1{11});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih_64{1}(Ev)),log(Ih_64{11}(Ev)),...
    log(Ih_32{1}(Ev)),log(Ih_32{11}(Ev)),log(Ih_16{1}(Ev)),log(Ih_16{11}(Ev)),...
    log(Ih_8{1}(Ev)),log(Ih_8{11}(Ev)),log(Ih_4{1}(Ev)),log(Ih_4{11}(Ev)),log(Ih_2{1}(Ev)),log(Ih_2{11}(Ev)),...
log(Ih_1{1}(Ev)),log(Ih_1{11}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(Ih_64{1},Ih_64{6},...
    Ih_32{1},Ih_32{6},Ih_16{1},Ih_16{6},...
Ih_8{1},Ih_8{6},Ih_4{1},Ih_4{6},Ih_2{1},Ih_2{6},...
Ih_1{1},Ih_1{6});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['Raman Spectrum for HH spinons: kappa = 0.1 J in a1 slab'])
xlabel('\omega/J^z');
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih_64{1}(Ev)),log(Ih_64{6}(Ev)),...
    log(Ih_32{1}(Ev)),log(Ih_32{6}(Ev)),log(Ih_16{1}(Ev)),log(Ih_16{6}(Ev)),...
    log(Ih_8{1}(Ev)),log(Ih_8{6}(Ev)),log(Ih_4{1}(Ev)),log(Ih_4{6}(Ev)),log(Ih_2{1}(Ev)),log(Ih_2{6}(Ev)),...
log(Ih_1{1}(Ev)),log(Ih_1{6}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['Raman Spectrum for HH spinons: kappa = 0.1 J in a1 slab (log plot)'])
xlabel('log(\omega/J^z)');
ylabel('log(I_{ac})');
...
hh=figure;%('Position',position);
hold on;
plot(Ih2_64{1},Ih2_64{2},...
    Ih2_32{1},Ih2_32{2},Ih2_16{1},Ih2_16{2},...
Ih2_8{1},Ih2_8{2},Ih2_4{1},Ih2_4{2},Ih2_2{1},Ih2_2{2},...
Ih2_1{1},Ih2_1{2});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih2_64{1}(Ev)),log(Ih2_64{2}(Ev)),...
    log(Ih2_32{1}(Ev)),log(Ih2_32{2}(Ev)),log(Ih2_16{1}(Ev)),log(Ih2_16{2}(Ev)),...
    log(Ih2_8{1}(Ev)),log(Ih2_8{2}(Ev)),log(Ih2_4{1}(Ev)),log(Ih2_4{2}(Ev)),log(Ih2_2{1}(Ev)),log(Ih2_2{2}(Ev)),...
log(Ih2_1{1}(Ev)),log(Ih2_1{2}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(Ih2_64{1},Ih2_64{11},...
    Ih2_32{1},Ih2_32{11},Ih2_16{1},Ih2_16{11},...
Ih2_8{1},Ih2_8{11},Ih2_4{1},Ih2_4{11},Ih2_2{1},Ih2_2{11},...
Ih2_1{1},Ih2_1{11});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih2_64{1}(Ev)),log(Ih2_64{11}(Ev)),...
    log(Ih2_32{1}(Ev)),log(Ih2_32{11}(Ev)),log(Ih2_16{1}(Ev)),log(Ih2_16{11}(Ev)),...
    log(Ih2_8{1}(Ev)),log(Ih2_8{11}(Ev)),log(Ih2_4{1}(Ev)),log(Ih2_4{11}(Ev)),log(Ih2_2{1}(Ev)),log(Ih2_2{11}(Ev)),...
log(Ih2_1{1}(Ev)),log(Ih2_1{11}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(Ih2_64{1},Ih2_64{6},...
    Ih2_32{1},Ih2_32{6},Ih2_16{1},Ih2_16{6},...
Ih2_8{1},Ih2_8{6},Ih2_4{1},Ih2_4{6},Ih2_2{1},Ih2_2{6},...
Ih2_1{1},Ih2_1{6});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['Raman Spectrum for HH spinons: kappa = 0.03 J in a1 slab'])
xlabel('\omega/J^z');
...
hh=figure;%('Position',position);
hold on;
plot(log(Ih2_64{1}(Ev)),log(Ih2_64{6}(Ev)),...
    log(Ih2_32{1}(Ev)),log(Ih2_32{6}(Ev)),log(Ih2_16{1}(Ev)),log(Ih2_16{6}(Ev)),...
    log(Ih2_8{1}(Ev)),log(Ih2_8{6}(Ev)),log(Ih2_4{1}(Ev)),log(Ih2_4{6}(Ev)),log(Ih2_2{1}(Ev)),log(Ih2_2{6}(Ev)),...
log(Ih2_1{1}(Ev)),log(Ih2_1{6}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['Raman Spectrum for HH spinons: kappa = 0.03 J in a1 slab (log plot)'])
xlabel('log(\omega/J^z)');
ylabel('log(I_{ac})');
...
hh=figure;%('Position',position);
hold on;
plot(I0_64{1},I0_64{2},...
    I0_32{1},I0_32{2},I0_16{1},I0_16{2},...
I0_8{1},I0_8{2},I0_4{1},I0_4{2},I0_2{1},I0_2{2},...
I0_1{1},I0_1{2});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(log(I0_64{1}(Ev)),log(I0_64{2}(Ev)),...
    log(I0_32{1}(Ev)),log(I0_32{2}(Ev)),log(I0_16{1}(Ev)),log(I0_16{2}(Ev)),...
    log(I0_8{1}(Ev)),log(I0_8{2}(Ev)),log(I0_4{1}(Ev)),log(I0_4{2}(Ev)),log(I0_2{1}(Ev)),log(I0_2{2}(Ev)),...
log(I0_1{1}(Ev)),log(I0_1{2}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
hh=figure;%('Position',position);
hold on;
plot(I0_64{1},I0_64{11},...
    I0_32{1},I0_32{11},I0_16{1},I0_16{11},...
I0_8{1},I0_8{11},I0_4{1},I0_4{11},I0_2{1},I0_2{11},...
I0_1{1},I0_1{11});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
% hh=figure;%('Position',position);
% hold on;
% plot(I0_0{10},I0_0{11},...
%     Ih2_0{10},Ih2_0{11},Ih_0{10},Ih_0{11});
% %errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
% title(['Raman Spectrum for HH spinons: TDL (pbc)'])
% xlabel('\omega/J^z');
% ylabel('I_{[ac]}');
...
hh=figure;%('Position',position);
hold on;
plot(I0_64{1},I0_64{6},...
    I0_32{1},I0_32{6},I0_16{1},I0_16{6},...
I0_8{1},I0_8{6},I0_4{1},I0_4{6},I0_2{1},I0_2{6},...
I0_1{1},I0_1{6});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['Raman Spectrum for HH spinons: kappa = 0 in a1 slab'])
xlabel('\omega/J^z');
...
hh=figure;%('Position',position);
hold on;
plot(log(I0_64{1}(Ev)),log(I0_64{6}(Ev)),...
    log(I0_32{1}(Ev)),log(I0_32{6}(Ev)),log(I0_16{1}(Ev)),log(I0_16{6}(Ev)),...
    log(I0_8{1}(Ev)),log(I0_8{6}(Ev)),log(I0_4{1}(Ev)),log(I0_4{6}(Ev)),log(I0_2{1}(Ev)),log(I0_2{6}(Ev)),...
log(I0_1{1}(Ev)),log(I0_1{6}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['Raman Spectrum for HH spinons: kappa = 0 in a1 slab (log plot)'])
xlabel('log(\omega/J^z)');
ylabel('log(I_{ac})');
...
plot(I0_0{10},I0_0{11},...
    Ih2_0{10},Ih2_0{11},Ih_0{10},Ih_0{11});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH spinons: TDL (pbc)'])
xlabel('\omega/J^z');
ylabel('DOS');
legend({'\kappa = 0','\kappa = 0.03','\kappa = 0.1'}, 'Location', 'SouthEast');
hold off;
...
hh=figure;%('Position',position);
hold on;
plot(log(I0_0{10}(Ev)),log(I0_0{11}(Ev)),...
    log(Ih2_0{10}(Ev)),log(Ih2_0{11}(Ev)),log(Ih_0{10}(Ev)),log(Ih_0{11}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['DOS for HH spinons: TDL (pbc) (log plot)'])
xlabel('log(\omega/J^z)');
ylabel('log(DOS)');
legend({'\kappa = 0','\kappa = 0.03','\kappa = 0.1'}, 'Location', 'SouthEast');
hold off;
...
disp(( log(I0_0{11}(Ev2)) - log(I0_0{11}(Ev1)) )/( log(I0_0{10}(Ev2)) - log(I0_0{10}(Ev1)) ))
disp(( log(Ih2_0{11}(Ev2)) - log(Ih2_0{11}(Ev1)) )/( log(Ih2_0{10}(Ev2)) - log(Ih2_0{10}(Ev1)) ))
disp(( log(Ih_0{11}(Ev2)) - log(Ih_0{11}(Ev1)) )/( log(Ih_0{10}(Ev2)) - log(Ih_0{10}(Ev1)) ))
...
%     log(Ih2_0{10}(Ev)),log(Ih2_0{11}(Ev)),log(Ih_0{10}(Ev)),log(Ih_0{11}(Ev)));
% %errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
% title(['Raman Spectrum for HH spinons: TDL (pbc) (log plot)'])
% xlabel('log(\omega/J^z)');
% ylabel('log(I_{[ac]})');
% legend({'\kappa = 0','\kappa = 0.03','\kappa = 0.1'}, 'Location', 'SouthEast');
% hold off;
...
hold on;
plot(I0_0{10},I0_0{4},...
    Ih2_0{10},Ih2_0{4},Ih_0{10},Ih_0{4});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['Raman Spectrum for HH spinons: TDL (pbc)'])
xlabel('\omega/J^z');
ylabel('I_{ac}');
...
hh=figure;%('Position',position);
hold on;
plot(log(I0_0{10}(Ev)),log(I0_0{4}(Ev)),...
    log(Ih2_0{10}(Ev)),log(Ih2_0{4}(Ev)),log(Ih_0{10}(Ev)),log(Ih_0{4}(Ev)));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
title(['Raman Spectrum for HH spinons: TDL (pbc) (log plot)'])
xlabel('log(\omega/J^z)');
ylabel('log(I_{ac})');
...
disp(( log(I0_0{4}(Ev2)) - log(I0_0{4}(Ev1)) )/( log(I0_0{10}(Ev2)) - log(I0_0{10}(Ev1)) ))
disp(( log(Ih2_0{4}(Ev2)) - log(Ih2_0{4}(Ev1)) )/( log(Ih2_0{10}(Ev2)) - log(Ih2_0{10}(Ev1)) ))
disp(( log(Ih_0{4}(Ev2)) - log(Ih_0{4}(Ev1)) )/( log(Ih_0{10}(Ev2)) - log(Ih_0{10}(Ev1)) ))



diary H0_slab8_diary_a1_2
