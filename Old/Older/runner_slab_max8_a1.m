...
log(Ih_1{1}),log(Ih_1{2}),log(Ih_0{1}),log(Ih_0{2}));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
log(Ih_1{1}),log(Ih_1{11}),log(Ih_0{1}),log(Ih_0{11}));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
Ih2_1{1},Ih2_1{2},Ih2_0{1},Ih2_0{2});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
log(Ih2_1{1}),log(Ih2_1{2}),log(Ih2_0{1}),log(Ih2_0{2}));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
Ih2_1{1},Ih2_1{11},Ih2_0{1},Ih2_0{11});
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
log(Ih2_1{1}),log(Ih2_1{11}),log(Ih2_0{1}),log(Ih2_0{11}));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
log(I0_1{1}),log(I0_1{2}),log(I0_0{1}),log(I0_0{2}));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
...
log(I0_1{1}),log(I0_1{11}),log(I0_0{1}),log(I0_0{11}));
%errorbar(Ev,Ipp+Imm+Ipm,errs(:,4)+errs(:,5)+errs(:,6));
