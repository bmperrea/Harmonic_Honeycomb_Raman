function out = KitaevRaman14_8_ac(N,bins,flag,nn,jx,jz,h)
...
%The six are the six symmetric binary products of R^aa, R^ac, R^cc
    %h1 = {aa, aa, aa, ac, ac, cc, ab, bc,[ac],[bc],[ac]};
    %h2 = {aa, ac, cc, ac, cc, cc, ab, bc,[ac],[bc],[bc]};
m1 = {1,1,1,3,3,5,2,4,6,7,6};
m2 = {1,3,5,3,5,5,2,4,6,7,7};
mm = size(m1,2);
