...
for n = 1:nn
    ...
    out = KitaevRaman14xy(N,bins,flag,nn,Jx,Jz,h);
...
%set(gca,'YTick',2*(0:5));
%hold off;
filename = ['3D_DOS_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(100*h),'_2xy'];
saveas(hh,filename)
...
%set(gca,'YTick',2*(0:5));
hold off;
filename = ['3D_DOS_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(100*h),'_xy'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
% 
...
hold off;
filename = ['3D_Raman_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_xy'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
hold off;
filename = ['3D_Raman_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_3xy'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
hold off;
filename = ['3D_Raman_2_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_2xy'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
