...
%         sn = sign( 3*pi/4 - abs(y-pi/sqrt(32))*sqrt(2) + x );
%         sn2 = sign( 3*pi/4 - abs(y+pi/sqrt(32))*sqrt(2) - x );

%         sn1 = sign( pi/sqrt(2) - y + x/sqrt(2) );
%         sn2 = sign( pi/sqrt(2) + y - x/sqrt(2) );
%         sn3 = sign( pi/(2*sqrt(2)) - y - x/sqrt(2) );
%         sn4 = sign( pi/(2*sqrt(2)) + y + x/sqrt(2) );
