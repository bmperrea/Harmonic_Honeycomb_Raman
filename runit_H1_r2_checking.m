...
for n = 1:nn
    ...
    out = KitaevRaman_H1_r2_checking(N,bins,flag,nn,Jx,Jz,h);
...
%set(gca,'YTick',2*(0:5));
%hold off;
filename = ['H1_DOS_',num2str(N),'_Jx_',num2str(round(100*Jx)),'_28'];
saveas(hh,filename)
...
hold off;
filename = ['H1_Raman_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_028'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
hold off;
filename = ['H1_Raman_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_328'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
hold off;
filename = ['H1_Raman_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_228'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
