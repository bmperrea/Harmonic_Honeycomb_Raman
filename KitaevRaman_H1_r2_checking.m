...
%     end
    ...
    F = 1i*[jz,0,0,Apy/p3;Apx,jz,0,0;0,Bpy,jz,0;0,0,Bpx,jz];
    zero = 0*F;
    Hf = [zero , F; F', zero];   
...
%     
    ...
    Apyc = jyac + jxac*conj(p1);
    Apxc = jxac + jyac*p1;
    
    Bpyc = jybc + jxbc*conj(p2);
    Bpxc = jxbc + jybc*p2;
    ...
    for n =1:nm
        %F = 1i*[jz,0,0,Apy/p3;Apx,jz,0,0;0,Bpy,jz,0;0,0,Bpx,jz];
RF = 1i*[jzc{n},0,0,Apyc{n}/p3;Apxc{n},jzc{n},0,0;0,Bpyc{n},jzc{n},0;0,0,Bpxc{n},jzc{n}];
