...
%     end
   ...
   % Bp2 = jxb + jyb*p2;
    ...
    F = 1i*[jz,jxa,0,0,0,jya,0,0;...
        0,jz,Bp,0,0,0,0,0;...
        0,0,jz,conj(Bp2),0,0,0,0; ...
  jya.*conj(p3),0,0,jz,jxa.*p1.^2.*conj(p3),0,0,0;...
  0,jya.*p1.^(-2),0, ...
  0,jz,jxa,0,0;0,0,0,0,0,jz,Bm,0;...
  0,0,0,0,0,0,jz,conj(Bm2);...
  jxa.*conj(p3),0,0,0,jya.*conj(p3),0,0,jz];
...
RF = 1i*[jzc{n},jxac{n},0,0,0,jyac{n},0,0;0,jzc{n},Bpc{n},0,0,0,0,0;0,0,jzc{n},conj(Bp2c{n}),0,0,0,0; ...
  jyac{n}.*conj(p3),0,0,jzc{n},jxac{n}.*p1.^2.*conj(p3),0,0,0;0,jyac{n}.*p1.^(-2),0, ...
  0,jzc{n},jxac{n},0,0;0,0,0,0,0,jzc{n},Bmc{n},0;0,0,0,0,0,0,jzc{n},conj(Bm2c{n});jxac{n}.*conj( ...
  p3),0,0,0,jyac{n}.*conj(p3),0,0,jzc{n}];
