function out = KitaevRaman_H1_r2(N,bins,flag,nn,jx,jz,~)
...
%     end
    ...
    F = 1i*[jz,conj(Ap2),0,0;0,jz,Bp,0;0,0,jz,conj(Bp2);Ap.*conj(p3),0,0,jz];
    zero = 0*F;
    Hf = [zero , F; F', zero];   
...
RF = 1i*[jzc{n},conj(Ap2c{n}),zeroc{n},zeroc{n};zeroc{n},jzc{n},Bpc{n},zeroc{n};...
    zeroc{n},zeroc{n},jzc{n},conj(Bp2c{n});Apc{n}.*conj(p3),zeroc{n},zeroc{n},jzc{n}];
