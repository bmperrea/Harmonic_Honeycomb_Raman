...
%set(gca,'YTick',2*(0:5));
%hold off;
filename = ['H1_DOS_',num2str(N),'_Jx_',num2str(round(100*Jx)),'_2'];
saveas(hh,filename)
...
hold off;
filename = ['H1_Raman_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_02'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
hold off;
filename = ['H1_Raman_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_32'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
...
hold off;
filename = ['H1_Raman_Jx_',num2str(round(100*Jx)),'_h_',num2str(h*100),'_22'];
saveas(hh,filename)
print(hh, '-dpng', filename);
print(hh, '-depsc', filename);
